        ...
        <div className="container max-w-4xl py-16 md:py-24 space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-12">
                <div className="space-y-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:seocalchub@gmail.com" className="text-primary font-medium hover:underline mt-2 block">
                                seocalchub@gmail.com
                            </a>
                        </div>
                    </div>
                ...
                <div className="bg-card border rounded-2xl p-8 shadow-sm">
                    ...
                    <form action="https://formsubmit.co/seocalchub@gmail.com" method="POST" className="space-y-4">
                        <div className="space-y-2">
                            <label htmlFor="name" className="text-sm font-medium">Name</label>
                            <input id="name" name="name" type="text" className="w-full p-3 rounded-lg border bg-transparent" placeholder="Your name" required />
                        </div>
                        <div className="space-y-2">
                            <label htmlFor="email" className="text-sm font-medium">Email</label>
                            <input id="email" name="email" type="email" className="w-full p-3 rounded-lg border bg-transparent" placeholder="you@example.com" required />
                        </div>
                        <div className="space-y-2">
                            <label htmlFor="message" className="text-sm font-medium">Message</label>
                            <textarea id="message" name="message" rows={4} className="w-full p-3 rounded-lg border bg-transparent" placeholder="How can we help?" required></textarea>
                        </div>
